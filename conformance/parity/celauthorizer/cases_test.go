...
func cases() []parity.Case {
	...
	return []parity.Case{
		...
		},
		{
			...
			OracleType: parity.OracleKubeAPIServerObservation, OracleRationale: "the Kubernetes 1.36.2 API server skips transport when false and runtime error conditions are combined",
			CoverageTags: []string{"false-and-error", "kube-apiserver", "match-condition-false"},
		...
		},
		{
			...
			OracleType: parity.OracleKubeAPIServerObservation, OracleRationale: "the Kubernetes 1.36.2 API server skips transport when failurePolicy Ignore handles a runtime error",
			CoverageTags: []string{"cel-runtime-error", "failure-policy-ignore", "kube-apiserver"},
		...
		},
		{
			...
			OracleType: parity.OracleOfficialMatcherDifferential, OracleRationale: "the official Kubernetes 1.36.2 stored-expression compiler and matcher reject the invalid expression",
			CoverageTags: []string{"cel-compile-error", "failure-policy-fail", "official-matcher"},
		...
		},
		{
			...
			OracleType: parity.OracleOfficialMatcherDifferential, OracleRationale: "the official Kubernetes 1.36.2 matcher applies failurePolicy Fail to an upstream out-of-budget result",
			CoverageTags: []string{"cel-cost-error", "failure-policy-fail", "official-matcher"},
		...
		authorizerCase("authorizer-allow", contract.AuthorizationVerdictAllow, parity.OracleOfficialMatcherDifferential, "the official Kubernetes 1.36.2 matcher evaluates the exact allow fixture as true", []string{"authorizer-allow", "fixture-contract", "official-matcher"}, contract.DeterminationDeterminate, &called, contract.ReasonCodeMatchConditionsTrue),
		authorizerCase("authorizer-deny", contract.AuthorizationVerdictDeny, parity.OracleOfficialMatcherDifferential, "the official Kubernetes 1.36.2 matcher evaluates the exact deny fixture as false", []string{"authorizer-deny", "fixture-contract", "official-matcher"}, contract.DeterminationDeterminate, &skipped, contract.ReasonCodeMatchConditionFalse),
		authorizerCase("authorizer-no-opinion", contract.AuthorizationVerdictNoOpinion, parity.OracleOfficialMatcherDifferential, "the official Kubernetes 1.36.2 matcher evaluates the exact no-opinion fixture as false", []string{"authorizer-no-opinion", "fixture-contract", "official-matcher"}, contract.DeterminationDeterminate, &skipped, contract.ReasonCodeMatchConditionFalse),
		authorizerCase("authorizer-error", contract.AuthorizationVerdictError, parity.OracleOfficialMatcherDifferential, "the official Kubernetes 1.36.2 matcher applies failurePolicy Fail to the exact fixture error", []string{"authorizer-error", "failure-policy-fail", "fixture-contract", "official-matcher"}, contract.DeterminationDeterminate, &rejected, contract.ReasonCodeCELAuthorizationError),
		{
